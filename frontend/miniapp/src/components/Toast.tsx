...
/**
 * Lightweight top-banner toast — auto-dismisses after 2.5s.
 * Replaces blocking `alert()` calls for non-critical feedback so the user
 * keeps context (e.g. "Đặt đơn thành công" while navigating to detail page).
 *
 * Critical decisions (cancel order, reject offer) still use tg.showConfirm /
 * tg.showAlert, which gracefully fall back to `alert()` outside Telegram.
 */
